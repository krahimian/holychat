...
cordova:
	...
	$(CPLUGIN) add org.apache.cordova.device
	$(CPLUGIN) add org.apache.cordova.statusbar
	$(CPLUGIN) add https://github.com/katzer/cordova-plugin-local-notifications.git
	$(CPLUGIN) add https://github.com/katzer/cordova-plugin-background-mode.git
	$(CORDOVA) prepare
